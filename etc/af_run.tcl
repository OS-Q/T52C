...
set ORIGINAL_QSF "__original_qsf__"
set ORIGINAL_PIN "__original_pin__"
...
if { $LOAD_DB } {
  ...
  if { ! [file exists $verilog] } {
    set verilog [file join __project_dir__ simulation modelsim ${DESIGN}.vo]
...
if { $LOAD_DB } {
  # Empty
} elseif { __is_compatible_device__ } {
  if { $ORIGINAL_PIN != "" } {
